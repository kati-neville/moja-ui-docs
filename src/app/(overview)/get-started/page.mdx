...
Moja UI comes with default styles as designed in [figma](/figma). These components are fully customisable to suite your particular needs. Read more on this under the [style guide section](/style-guide)
