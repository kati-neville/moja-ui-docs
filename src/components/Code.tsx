  ...
  return (
    <button
      ...
      className={clsx(
        ...
        copied
          ? 'bg-primary-400 ring-primary-400 text-white ring-1 ring-inset'
    ...
    >
      ...
      <span
        aria-hidden={!copied}
        className={clsx(
          'text-white-400 pointer-events-none absolute inset-0 flex items-center justify-center transition duration-300',
          !copied && 'translate-y-1.5 opacity-0',
        )}
      >
        Copied!
...
}>()((set: (arg0: (state: any) => { preferredLanguages: any[] }) => any) => ({
  preferredLanguages: [],
  addPreferredLanguage: (language: any) =>
    set((state: { preferredLanguages: any[] }) => ({
      preferredLanguages: [
        ...state.preferredLanguages.filter(
          (preferredLanguage: any) => preferredLanguage !== language,
        ),
        language,
      ],
    })),
