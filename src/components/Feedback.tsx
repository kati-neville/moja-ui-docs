...
>(function FeedbackThanks({ className, ...props }, ref) {
  return (
    ...
    >
      <div className="dark:ring-primary-500 dark:bg-primary-500/30 text-primary-500 ring-primary-400/80 bg-primary-300/10 flex items-center gap-3 rounded-full py-1 pl-1.5 pr-3 text-sm ring-1 ring-inset dark:text-white">
        <CheckIcon className="fill-primary-300 dark:fill-primary-300/40 h-5 w-5 flex-none stroke-white dark:stroke-white" />
