  ...
  return {
    DEFAULT: {
      css: {
        ...
        '--tw-prose-links-hover': theme('colors.primary.500'),
        '--tw-prose-links-underline': theme('colors.primary.500 / 0.6'),
        ...
        '--tw-prose-invert-links-underline': theme('colors.primary.400 / 0.5'),
